...
const contacts = [
  {
    name: "Email",
    value: "johanes.rendy@example.com",
    icon: Mail,
    link: "mailto:johanes.rendy@example.com",
  },
  {
    name: "LinkedIn",
    value: "linkedin.com/in/johanes-rendy",
    icon: Linkedin,
    link: "https://linkedin.com/in/johanes-rendy",
  },
  {
    name: "GitHub",
    value: "github.com/johanes-rendy",
    icon: Github,
    link: "https://github.com/johanes-rendy",
  },
]
            ...
            {contacts.map((contact, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-base sm:text-lg font-bold">{contact.name}</h3>
